...
$chkLogin = $link->prepare( 'SELECT * FROM rmuser WHERE username=:username AND password=:password' );
...
$userInfo = $chkLogin->fetch( PDO::FETCH_ASSOC );
